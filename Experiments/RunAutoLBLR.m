...
DATASET = '../Datasets/Behaviors/RobotDogWalking.mat';
OUTPUT_FOLDER = 'RobotDogWalking'; % Outputs all results to this directory
SAVEPLOTS = true; % Save the plots generated by AutoLBLR to file?
...
%% GENERATE PLOTS
if SAVEPLOTS
    mkdir(pwd, [OUTPUT_FOLDER '/Plots/AutoLBLR']);

    for i = 1:numel(PlotHandles)
        str = [OUTPUT_FOLDER '/Plots/AutoLBLR/' get(PlotHandles(i), 'name') '.fig'];
